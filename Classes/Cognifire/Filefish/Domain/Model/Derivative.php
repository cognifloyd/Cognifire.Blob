<?php
namespace Cognifire\Filefish\Domain\Model;
...
use Cognifire\Filefish\Package\GenericPackageManager;
use Cognifire\Filefish\Package\PackageManagerInterface;
use TYPO3\Flow\Annotations as Flow;
use TYPO3\Flow\Utility\Algorithms;
use TYPO3\Flow\Utility\Files;
use Cognifire\Filefish\Exception;
...
class Derivative {
	 ...
	 *   FLOW_PATH_DATA/Data/Filefish. By default, this will generate a new Uuid prefixed with '@' as the directory's name.
	 *
	 *     $d = new Derivative();
	 *
	...
	protected function initializeAbsolutePathAndCreateDirectory() {
		...
		if('@' === substr($this->derivativeKey, 0, 1)) {
			$this->absolutePath = Files::concatenatePaths(array(FLOW_PATH_DATA, 'Filefish', $this->derivativeKey));
